...
namespace CRM.Controllers
{
    public class AutentificacionController : Controller
    {
                ...
                try
                {
                    ...
                    if (LicenciaValida)
                    {
                        ...
                        if (dataBase != null)
                        {
                            ...
                            BD.Database.ExecuteSqlCommand("IF   NOT EXISTS (SELECT * FROM sysobjects WHERE NAME='CRM_Usuarios_Rol'  and TYPE='U') BEGIN CREATE TABLE CRM_Usuarios_Rol (ID BIGINT PRIMARY KEY IDENTITY(1, 1) NOT NULL,codigoEmpresa varchar(6),alias VARCHAR(20), nombreUser VARCHAR(20),contrase VARCHAR(20),email varchar(50),Rol VARCHAR(50),) END");
                            ...
                            if (usuario_rol != null)
                            {
                                ...
                                Session["catalog_user"] = codigo_momentaeio + "BDCOMUN";
        ...
        public void Verificar_Data() {
            ...
            {
                string base_datos = i.EMP_CODIGO + "BDCOMUN";
        ...
        public void Verificar_Data_User_Admin(CRM_Usuarios_Rol model)
        {
            ...
            foreach (var i in empresas_asociadas)
            {
                string base_datos = i.codigoEmpresa + "BDCOMUN";
